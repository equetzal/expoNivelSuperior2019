...
public class carrera_nesc extends AppCompatActivity {
    ImageView btnBack;
    ImageView logo;
    ImageView imgCarr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carrera_nesc);
        ...
        urlMapaCurricular = getString(this.getResources().getIdentifier("mapaCurr"+parentIntent.getStringExtra("carr")+parentIntent.getStringExtra("esc")+"_NESC","string", this.getPackageName()));
