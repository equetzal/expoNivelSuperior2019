...
public class esc_ESM extends AppCompatActivity implements View.OnClickListener {
    ImageButton btnMapa;
    ImageView btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.esc_esm);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btnMapa:
                Uri intentUri = Uri.parse("geo:19.451037,-99.1684477?z=17&q=19.451037,-99.1684477(ESM)");
                i = new Intent(Intent.ACTION_VIEW, intentUri);
                break;

            case R.id.btnWebEsc:
                url = getString(R.string.httpESM);
            ...
            case R.id.btnVerCarrMCP:
                i = new Intent(esc_ESM.this, carrera_esc.class);
                i.putExtra("logo","esm");
