...
public class carr_IAlim extends AppCompatActivity implements View.OnClickListener{
    ImageView btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.carr_ialim);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btnEscEscUPIBI:
                i = new Intent(carr_IAlim.this, carrera_esc.class);
