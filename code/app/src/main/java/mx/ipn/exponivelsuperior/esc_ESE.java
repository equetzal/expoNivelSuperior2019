...
public class esc_ESE extends AppCompatActivity implements View.OnClickListener {
    ImageButton btnMapa;
    ImageView btnBack;
    ...
    LinearLayout btnVerCarrLEcono;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.esc_ese);
        ...
        btnVerCarrLEcono = findViewById(R.id.btnVerCarrLEcono);
        ...
        btnVerCarrLEcono.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btnMapa:
                Uri intentUri = Uri.parse("geo:19.454973,-99.1682227?z=16.4&q=19.454973,-99.1682227(ESE)");
                i = new Intent(Intent.ACTION_VIEW, intentUri);
                break;

            case R.id.btnWebEsc:
                url = getString(R.string.httpESE);
            ...
            case R.id.btnVerCarrLEcono:
                i = new Intent(esc_ESE.this, carrera_esc.class);
                i.putExtra("logo","ese");
