...
public class nesc_carr_LRC extends AppCompatActivity implements View.OnClickListener {
    ImageView btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nesc_carr_lrc);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btnNescEscESCA_UTep:
                i = new Intent(nesc_carr_LRC.this, carrera_nesc.class);
