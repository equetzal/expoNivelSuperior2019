...
public class carr_CP extends AppCompatActivity implements View.OnClickListener {
    ImageView btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.carr__cp);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btnEscEscESCA_UTep:
                i = new Intent(carr_CP.this, carrera_esc.class);
