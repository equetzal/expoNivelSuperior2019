...
public class carrera_mixta extends AppCompatActivity {
    ImageView btnBack;
    ImageView logo;
    ImageView imgCarr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carrera_mixta);
        ...
        urlMapaCurricular = getString(this.getResources().getIdentifier("mapaCurr"+parentIntent.getStringExtra("carr")+parentIntent.getStringExtra("esc")+"_mix","string", this.getPackageName()));
