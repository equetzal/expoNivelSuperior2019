...
public class carr_LRC extends AppCompatActivity implements View.OnClickListener {
    ImageView btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.carr_lrc);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btnEscEscESCA_UTep:
                i = new Intent(carr_LRC.this, carrera_esc.class);
