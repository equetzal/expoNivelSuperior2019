...
public class esc_ESCOM extends AppCompatActivity implements View.OnClickListener {
    ImageButton btnMapa;
    ImageView btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.esc_escom);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btnMapa:
                Uri intentUri = Uri.parse("geo:19.5046526,-99.1466253?z=16.79&q=19.5046526,-99.1466253(ESCOM)");
                i = new Intent(Intent.ACTION_VIEW, intentUri);
                break;

            case R.id.btnWebEsc:
                url = getString(R.string.httpESCOM);
            ...
            case R.id.btnVerCarrISC:
                i = new Intent(esc_ESCOM.this, carrera_esc.class);
