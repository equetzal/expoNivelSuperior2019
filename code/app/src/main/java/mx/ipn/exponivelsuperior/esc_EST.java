...
public class esc_EST extends AppCompatActivity implements View.OnClickListener{
    ImageButton btnMapa;
    ImageView btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.esc_est);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btnVerCarrLTuri:
                i = new Intent(esc_EST.this, carrera_esc.class);
                i.putExtra("logo","est");
